...
fig2 <- function() {
  ...
  p2 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(ModelWaterEngulfFullDirectAdjust))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = bquote("Log"^10*" Speed At Mouth Opening (m s"^-1*")"),
  ...
  p3 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnCostkJ))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = bquote("Log"^10*" Speed At Mouth Opening (m s"^-1*")"),
         y = bquote("Log"^10*" Lunge Energetic Cost (Watts)")) +
    theme_classic(base_size = 8) +
    theme(axis.text = element_text(size = 20),
          axis.title = element_text(size = 24),
          axis.title.x = element_blank(),
  ...
  p4 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnCostMS))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = bquote("Log"^10*" Speed At Mouth Opening (m s"^-1*")"),
         y = bquote("Log"^10*" Mass-Specific Lunge Energetic Cost (Watts kg"^-1*")")) +
    theme_classic(base_size = 8) +
    theme(axis.text = element_text(size = 20),
          axis.title = element_text(size = 24),
          axis.title.x = element_blank(),
  ...
  p5 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnPerLungeDirectAdjust))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = bquote("Log"^10*" Speed At Mouth Opening (m s"^-1*")"),
  ...
  p6 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnPerLungeDirectAdjustMS))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = bquote("Log"^10*" Speed At Mouth Opening (m s"^-1*")"),
  ...
  p7 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnRatioDirectAdjust))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = bquote("Log"^10*" Speed At Mouth Opening (m s"^-1*")"),
         y = bquote("Log"^10*" Lunge Energetic Cost/Gain Ratio")) +
    theme_classic(base_size = 8) +
    theme(axis.text = element_text(size = 20),
          axis.title = element_text(size = 24),
          axis.title.x = element_blank(),
  ...
  p8 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnRatioDirectAdjustAvgPrey))) +
    ...
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = bquote("Log"^10*" Speed At Mouth Opening (m s"^-1*")"),
         y = bquote("Log"^10*" Averaged Prey Lunge Energetic Cost/Gain Ratio")) +
    theme_classic(base_size = 8) +
    theme(axis.text = element_text(size = 20),
          axis.title = element_text(size = 24),
          axis.title.x = element_blank(),
  ...
  p13 <- cowplot::plot_grid(p1, p3, p5, p7, p2, p4, p6, p8,
                           nrow = 2,
                           ncol = 4,
                           align = "v",
                           axis = "bl",

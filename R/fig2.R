...
fig2 <- function() {
  ...
  p5 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(SpdBegDecel,SlpDecel)) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = "Speed At Mouth Opening (m s-1)",
  ...
  p6 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(ModelWaterEngulfFullDirectAdjust))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
  ...
  p7 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnCostkJ))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = "Log10 Speed At Mouth Opening (m s-1)",
  ...
  p8 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnCostMS))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = "Log10 Speed At Mouth Opening (m s-1)",
  ...
  p9 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnPerLungeDirectAdjust))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = "Log10 Speed At Mouth Opening (m s-1)",
  ...
  p10 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnPerLungeDirectAdjustMS))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = "Log10 Speed At Mouth Opening (m s-1)",
         y = "Log10 Mass-Specific Lunge Energetic Gain (kJ kg-1)") +
    theme_classic(base_size = 8) +
    theme(axis.text = element_text(size = 20),
          axis.title = element_text(size = 24),
          axis.title.x = element_blank(),
  ...
  p11 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnRatioDirectAdjust))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = "Log10 Speed At Mouth Opening (m s-1)",
  ...
  p12 <- ggplot(LungeKinematics::AllWhalesLungeTableTrunc, aes(log10(SpdBegDecel),log10(EnRatioDirectAdjustAvgPrey))) +
    geom_point(aes(fill = Species), color = "black", shape = 21, alpha = 0.5, size = 3) +
    geom_smooth(method = lm, aes(group = whaleName, colour = Species, fill = Species), se = FALSE) +
    scale_color_manual(values = pal, aesthetics = c("fill","colour")) +
    labs(x = "Log10 Speed At Mouth Opening (m s-1)",
         y = "Log10 Averaged Prey Lunge Energetic Cost/Gain Ratio") +
    theme_classic(base_size = 8) +
    theme(axis.text = element_text(size = 20),
          axis.title = element_text(size = 24),
          axis.title.x = element_blank(),
...
#LengthAcc, LengthDecel, AccelSpdGain, DecelSpdLoss, SlpDecel, ModelWaterEngulfFullDirectAdjust, EnCostkJ, EnCostMS, EnPerLungeDirectAdjust, EnPerLungeDirectAdjustMS, EnRatioDirectAdjust, EnRatioDirectAdjustAvgPrey
